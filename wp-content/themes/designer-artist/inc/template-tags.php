 ...
 * Posts pagination.
 */
if ( ! function_exists( 'designer_artist_blog_posts_pagination' ) ) {
	function designer_artist_blog_posts_pagination() {
		$pagination_type = get_theme_mod( 'designer_artist_blog_pagination_type', 'blog-page-numbers' );
