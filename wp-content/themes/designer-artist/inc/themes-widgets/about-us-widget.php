...
class Designer_Artist_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Designer_Artist_About_Widget',
			__('VW About us', 'designer-artist'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'designer-artist' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','designer-artist'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','designer-artist'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','designer-artist'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','designer-artist'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','designer-artist'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','designer-artist'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function designer_artist_about_custom_load_widget() {
	register_widget( 'Designer_Artist_About_Widget' );
}
add_action( 'widgets_init', 'designer_artist_about_custom_load_widget' );