...
<div class="container">
  <main id="maincontent" class="middle-align pt-5" role="main">
      ...
      <div id="our-services" class="services"> 
        ...
        <div class="navigation">
          ...
          ?>
            ...
            <?php }else if($designer_artist_theme_lay == 'Three Columns'){ ?>
      <div class="row">
        <div class="col-lg-3 col-md-3" id="sidebar"><?php dynamic_sidebar('sidebar-1');?></div>
        <div id="our-services" class="services col-lg-6 col-md-6">
          <?php if( get_theme_mod( 'designer_artist_blog_post_pagination_position','bottom') == 'top' || get_theme_mod( 'designer_artist_blog_post_pagination_position','bottom') == 'both') { ?>
          ...
          ?>
          <?php if( get_theme_mod( 'designer_artist_blog_post_pagination_position','bottom') == 'bottom' || get_theme_mod( 'designer_artist_blog_post_pagination_position','bottom') == 'both') { ?>
            <?php if( get_theme_mod( 'designer_artist_blog_pagination_hide_show',true) == 1) { ?>
              <div class="navigation">
                <?php designer_artist_blog_posts_pagination(); ?>
                  <div class="clearfix"></div>
    ...
    <?php }else if($designer_artist_theme_lay == 'Four Columns'){ ?>
      <div class="row">
        <div class="col-lg-3 col-md-3" id="sidebar"><?php dynamic_sidebar('sidebar-1');?></div>
