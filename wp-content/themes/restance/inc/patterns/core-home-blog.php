...
return array(
	...
	'content'    => '<!-- wp:group {"style":{"spacing":{"padding":{"right":"20px","left":"20px","bottom":"60px"}}},"layout":{"contentSize":"1140px"}} -->
<div class="wp-block-group" style="padding-right:20px;padding-bottom:60px;padding-left:20px"><!-- wp:columns -->
...
<p class="has-text-align-center restance-animate restance-move-up restance-delay-1 has-secondary-color has-text-color has-heading-5-font-size" style="font-style:normal;font-weight:700;line-height:0.9;text-transform:uppercase;letter-spacing:1px">Our News</p>
<!-- /wp:paragraph -->
...
<h2 class="has-text-align-center restance-animate restance-move-up restance-delay-3 has-primary-color has-text-color has-heading-2-font-size" style="line-height:1;margin-bottom:60px">Latest News</h2>
<!-- /wp:heading -->
